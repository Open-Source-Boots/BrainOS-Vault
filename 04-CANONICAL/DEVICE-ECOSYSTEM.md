...
| Laptop | Intel Core i5-1135G7 @ 2.40GHz, Intel Iris Xe integrated GPU, 8GB RAM, Windows | Primary BrainOS device. Hostname: DESKTOP-QS71AHN |
...
| Syncthing | ⚠️ Downloaded | Not fully configured |
...
|---|---|---|---|
| Gemma 3 1B Instruct | (prior install, removed) | — | ❌ Removed |
...
**Primary model for structured tasks:** Qwen 3.5 9B Q4_K_M (thinking OFF)
